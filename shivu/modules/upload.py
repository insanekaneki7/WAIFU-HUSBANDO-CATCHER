...
rarity_map = 1 (⚪️ Common), 2 (🟣 Rare) , 3 (🟡 Legendary), 4 (🟢 Medium), 5 (💮 Exclusive), 6 (🔮 Limited Edition), 7 (👘 Kimono), 8 (❄⛄ Winter), 9 (👶Chibi), 10 (🐰Bunny)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 Exclusive", 6: "🔮 Limited Edition", 7: "👘 Kimono", 8: "❄⛄ Winter", 9: "👶Chibi", 10: "🐰Bunny"}
        try:
